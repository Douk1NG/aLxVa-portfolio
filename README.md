...
This project uses modern tools to ensure code quality:

- **Husky & lint-staged**: Automatically runs linting and Prettier on staged files before each commit.
- **Commitlint**: Enforces [Conventional Commits](https://www.conventionalcommits.org/) for standardized commit messages.
- **Prettier**: Consistent code formatting.
- **Vitest**: Fast unit and integration testing suite.
- **GitHub Actions**: Automated CI pipeline on every Pull Request.
