  ...
  return createPortal(
    ...
    >
      ...
      >
        <button
          onClick={scrollPrev}
          className="hidden lg:flex shrink-0 p-3 rounded-full bg-card/50 hover:bg-card border border-border shadow-lg transition-all hover:scale-110 active:scale-95 text-muted-foreground hover:text-primary backdrop-blur-sm"
          aria-label="Previous"
        >
